...
const Contact = () => {
  ...
  return (
    <section
      className="w-full h-full md:py-[100px] py-12 bg-stone-500"
      ref={revealContainer}
      id="contact"
    >
      ...
      <div className="flex w-full gap-24 lg:flex-row flex-col">
        ...
        >
          <input
            className="mb-4 outline-none py-3 px-2 text-[#202020] placeholder:text-[#202020] rounded-lg font-me  outline-0"
            type="text"
          ...
          />
          <input
            className="mb-4 py-3 px-2 rounded-lg outline-0 text-[#202020] placeholder:text-[#202020]"
            type="email"
            placeholder="Email"
            required
            name="user_email"
          ...
          <textarea
            name="message"
            placeholder="Message"
            className="mb-4  py-3 px-2 rounded-lg  h-[120px] outline-0 text-[#202020] placeholder:text-[#202020]"
            required
          ></textarea>
          <button
